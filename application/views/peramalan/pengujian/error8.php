      ...
      <div class="card-body">
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              ...
              <th><?php echo $error_alpha8['person']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8['person']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8['bicycle']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8['bicycle']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8['car']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8['car']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8['motorbike']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8['motorbike']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
      ...
      <div class="card-body">
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_2['person']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_2['person']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_2['bicycle']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_2['bicycle']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_2['car']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_2['car']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_2['motorbike']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_2['motorbike']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
      ...
      <div class="card-body">
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_3['person']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_3['person']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_3['bicycle']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_3['bicycle']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_3['car']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_3['car']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
        <br><br>
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <tr>
              <th colspan="3" style="text-align: right;">JUMLAH PE</th>
              <th><?php echo $error_alpha8_3['motorbike']['jumlah_pe'] ?>%</th>
            </tr>
            <tr>
              <th colspan="3" style="text-align: right;">MAPE</th>
              <th><?php echo $error_alpha8_3['motorbike']['mape'] ?>%</th>
            </tr>
          </tfoot>
        </table>
