    ...
    <div id="collapseOne" class="collapse" data-parent="#accordion">
      <div class="card-body">
        ...
        <table id="table_peramalan_detail" class="table table-bordered table-striped">
          ...
          <tfoot>
            <th colspan="6" style="text-align: right;">Forecasting result for the next day using alpha 0,2 = </th>
          ...
          <tbody>
            ...
            for ($i = 0; $i < 7; $i++): ?>
              <tr>
                ...
                <td><?php echo $alpha2_3['smoothing1'][$i]['person']; ?></td>
                <td><?php echo $alpha2_3['smoothing2'][$i]['person']; ?></td>
                <td><?php echo $alpha2_3['konstantaA'][$i]['person']; ?></td>
                <td><?php echo $alpha2_3['konstantaB'][$i]['person']; ?></td>
                <td><?php echo $alpha2_3['forecast'][$i]['person']; ?></td>
              </tr>
            <?php endfor; ?>
          </tbody>
          <tfoot>
            <th colspan="6" style="text-align: right;">Forecasting result for the next day using alpha 0,2 = </th>
            <th><?php echo $alpha2_3['forecast'][7]['person']; ?></th>
          </tfoot>
        </table>  
        <br><br>
          ...
          <tbody>
            ...
            for ($i = 0; $i < 7; $i++): ?>
              <tr>
                ...
                <td><?php echo $alpha2_3['smoothing1'][$i]['bicycle']; ?></td>
                <td><?php echo $alpha2_3['smoothing2'][$i]['bicycle']; ?></td>
                <td><?php echo $alpha2_3['konstantaA'][$i]['bicycle']; ?></td>
                <td><?php echo $alpha2_3['konstantaB'][$i]['bicycle']; ?></td>
                <td><?php echo $alpha2_3['forecast'][$i]['bicycle']; ?></td>
              </tr>
            <?php endfor; ?>
          </tbody>
          <tfoot>
            <th colspan="6" style="text-align: right;">Forecasting result for the next day using alpha 0,2 = </th>
            <th><?php echo $alpha2_3['forecast'][7]['bicycle']; ?></th>
          </tfoot>
        </table>
        <br><br>
          ...
          <tbody>
            ...
            for ($i = 0; $i < 7; $i++): ?>
              <tr>
                ...
                <td><?php echo $alpha2_3['smoothing1'][$i]['car']; ?></td>
                <td><?php echo $alpha2_3['smoothing2'][$i]['car']; ?></td>
                <td><?php echo $alpha2_3['konstantaA'][$i]['car']; ?></td>
                <td><?php echo $alpha2_3['konstantaB'][$i]['car']; ?></td>
                <td><?php echo $alpha2_3['forecast'][$i]['car']; ?></td>
              </tr>
            <?php endfor; ?>
          </tbody>
          <tfoot>
            <th colspan="6" style="text-align: right;">Forecasting result for the next day using alpha 0,2 = </th>
            <th><?php echo $alpha2_3['forecast'][7]['car']; ?></th>
          </tfoot>
        </table>
          ...
          <tbody>
            ...
            for ($i = 0; $i < 7; $i++): ?>
              <tr>
                ...
                <td><?php echo $alpha2_3['smoothing1'][$i]['motorbike']; ?></td>
                <td><?php echo $alpha2_3['smoothing2'][$i]['motorbike']; ?></td>
                <td><?php echo $alpha2_3['konstantaA'][$i]['motorbike']; ?></td>
                <td><?php echo $alpha2_3['konstantaB'][$i]['motorbike']; ?></td>
                <td><?php echo $alpha2_3['forecast'][$i]['motorbike']; ?></td>
              </tr>
            <?php endfor; ?>
          </tbody>
          <tfoot>
            <th colspan="6" style="text-align: right;">Forecasting result for the next day using alpha 0,2 = </th>
            <th><?php echo $alpha2_3['forecast'][7]['motorbike']; ?></th>
          </tfoot>
        </table>
      </div>
    </div>
