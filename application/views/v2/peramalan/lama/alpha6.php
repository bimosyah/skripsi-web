...
<table id="table_peramalan_detail" class="table table-bordered table-striped">
  ...
  <tbody>
    <?php $i = 1; ?>
    <?php foreach ($alpha6['smoothing1'] as $key => $value): ?>
      <tr>
...
<table id="table_peramalan_detail" class="table table-bordered table-striped">
  ...
  <tbody>
    <?php $i = 1; ?>
    <?php foreach ($alpha6['smoothing2'] as $key => $value): ?>
      <tr>
        <td>s''t <?php echo $i; ?></td>
        <td><?php echo $value['person'] ?></td>
        <td><?php echo $value['bicycle'] ?></td>
...
<table id="table_peramalan_detail" class="table table-bordered table-striped">
  ...
  <tbody>
    <?php $i = 1; ?>
    <?php foreach ($alpha6['konstantaA'] as $key => $value): ?>
      <tr>
        <td>a <?php echo $i; ?></td>
        <td><?php echo $value['person'] ?></td>
        <td><?php echo $value['bicycle'] ?></td>
...
<table id="table_peramalan_detail" class="table table-bordered table-striped">
  ...
  <tbody>
    <?php $i = 1; ?>
    <?php foreach ($alpha6['konstantaB'] as $key => $value): ?>
      <tr>
        <td>b <?php echo $i; ?></td>
        <td><?php echo $value['person'] ?></td>
        <td><?php echo $value['bicycle'] ?></td>
...
<table id="table_peramalan_detail" class="table table-bordered table-striped">
  ...
  <tbody>
    <?php foreach ($alpha6['forecast'] as $key => $value): ?>
      <tr>
        <td><?php echo $value['person'] ?></td>
        <td><?php echo $value['bicycle'] ?></td>
        <td><?php echo $value['car'] ?></td>
